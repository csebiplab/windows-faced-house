  ...
  return (
    <section className="bg-[#EAF3F5] py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-r-2xl rounded-l-2xl">
          {/* Banner Section */}
          <div className="bg-[#111] text-white rounded-2xl overflow-hidden flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="p-8 md:p-12 flex-1">
              ...
              <p className="text-xs text-gray-400 max-w-xs">
                Оплачивайте первоначальный взнос от 20% (наличными или картой) в
                день заключения договора. Выплачивайте остаток равными частями в
                течение 6 месяцев. Без комиссий и переплат.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-left">
            {steps.map((step) => (
              <div key={step.id} className="p-6 flex flex-col">
